...
The next thing to do is to copy the `Felidaeloci.treefile` file into the same directory where you have your wASTRAL program. Then go to that directory in your terminal and put in the following commands:
